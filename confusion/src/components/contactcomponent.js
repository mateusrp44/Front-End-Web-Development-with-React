...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.email && email.split('').filter(x => x === '@').length !== 1)
            errors.email = 'E-Mail should contain a @';
    ...
    render() {
        const errors = this.validate(this.state.firstname,
            this.state.lastname, this.state.telnum,
            this.state.email);
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={ this.handleSubmit }>
                            ...
                            <FormGroup row>
                                <Label for="email" md={2}>E-Mail</Label>
                                <Col md={10}>
                                    <Input type="text" id="email" name="email"
                                        placeholder="E-Mail Address" value={ this.state.email }
                                        valid={ errors.email === '' }
                            ...
                            <FormGroup row>
                                <Label for="message" md={2}>My Feedback</Label>
                                <Col md={10}>
                                    <Input type="textarea" id="message" name="message" rows="12"
                                        placeholder="My message" value={ this.state.message }
                                        onChange={ this.handleInputChange } />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
